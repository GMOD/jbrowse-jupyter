...
| Deletion of tracks        | &#x2611; | &#x2612; | &#x2611; | &#x2612; | &#x2612;| &#x2612; | &#x2612; |
| Export view as SVG        | &#x2611; &ast; | &#x2611;   | &#x2611;| &#x2612; | &#x2612; | &#x2612; | &#x2611;|
| Local file support        | &#x2611; &ast;&ast; | &#x2611;   | &#x2611; | &#x2611;| &#x2611; | &#x2611; | &#x2611; |
| Supports Circular Genome View | &#x2611; | &#x2612; | &#x2612; | &#x2611; | &#x2612; | &#x2612; | &#x2612; |
| Ability to enable text searching from indexed files | &#x2611; | &#x2612; | &#x2612; | &#x2612; | &#x2612; | &#x2612; | &#x2612; |
| Ability to add tracks from Dataframes  | &#x2611; | &#x2612; | &#x2612; | &#x2612; | &#x2612; | &#x2611; | &#x2612;| 
| Zooming in on regions of interest | &#x2611; &ast; | &#x2611;  | &#x2611; &ast;| &#x2611; &ast; | &#x2611; &ast;| &#x2612; | &#x2611; &ast; |

&ast; Feature is accessible via the component's UI and not by API.
&ast;&ast; Path support for local files is only available when running notebook in Jupyter lab and Jupyter notebook. Local file support in colab and binder is available by running the JBrowse dev server to host your data and creating urls to pass to the JBrowse view.
